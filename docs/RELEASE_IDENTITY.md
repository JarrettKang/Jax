...
Android and Windows launcher icons derive from the original MIT-licensed
[geometric J source](../assets/branding/jax_icon.svg). Legacy, round, adaptive
and Windows multi-size assets are generated by tool/generate_branding.ps1;
ordinary builds use the committed outputs. This is a simple release placeholder,
not a final brand-design or trademark-registration claim. See
[third-party notices](THIRD_PARTY_NOTICES.md) and
[reproducibility evidence](REPRODUCIBILITY.md). Product and assistant identities
remain separate. README/publication work belongs to a later phase.
