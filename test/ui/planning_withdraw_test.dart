...
void main() {
  for (final platform in [TargetPlatform.android, TargetPlatform.windows]) {
    testWidgets('direct draft dispatch and both withdrawal menus $platform', (
      tester,
    ) async {
      await tester.runAsync(() async {
        ...
        await more('plan-item-more-fixture-step-0', '加入今日');
        expect(
        ...
        expect(pc.itemsFor('fixture-plan').first.status, PlanItemStatus.draft);
        ...
        await settle();
        // Existing remove action is separate and leaves the Event dispatched.
        await tester.tap(find.byKey(ValueKey('today-remove-${event.id}')));
        await settle();
        ...
        expect(ec.todayEvents, isEmpty);
        await pc.dispatchRecommendations(['fixture-step-0']);
        await settle();
